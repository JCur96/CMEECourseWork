...
k = 8.6173303e-05 
################ Reading data in ##################################
options(warn=-1) # silencing the warnigs as theres nothing I can do about them now!
...
ggsave("../Results/Figure_Graphic/Fig_MTD4400.pdf", plot_list$MTD4400)
...
mergedAIC %>% filter(UniqueID == "MTD4400")
mergedBIC %>% filter(UniqueID == "MTD4400")
