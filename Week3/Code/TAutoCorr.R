...
hist(coeff.vec)
# sticking a line where your unjumbled corr value appears
abline(v = corr.est,col = "red")

# Essentially asks which percentile the corr value found falls in 
